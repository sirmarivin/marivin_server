...
public class DeletingEmail {
    ...
    public static void delete() throws MessagingException {
        ...
        String port = "993";
        String userName = Utilities.thisServerEmail;
        String password = Utilities.thisServerPassword;
        ...
        try {
            ...
            for (int i = 0; i < arrayMessages.length; i++) {
                ...
                if (message.getSentDate().equals(ReadingEmail.timeIn)
                        && subject.contains(ReadingEmail.fileReady)) {
